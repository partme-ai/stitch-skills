# stitch-vue-element-components Usage

## When to use

- User has a Stitch screen and wants **Vue 3 + Element Plus** (Vite, .vue SFC) components that match the design.
...
4. Parse HTML; map to Element Plus components per references/contract.md; create Vue SFCs using resources/component-template.vue and src/data/mockData.js.
